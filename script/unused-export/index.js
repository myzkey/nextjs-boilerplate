...
const result = analyzeTsConfig(config.tsconfig)
...
if (items.length === 0) {
  console.info(green + '0 modules with unused exports')
} else {
  console.error(red + `${items.length} modules with unused exports`)
